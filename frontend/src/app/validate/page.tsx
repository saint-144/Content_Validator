            ...
            {mode === 'upload' ? (
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                <div style={{
                  ...
                  <span style={{ color: '#6366f1', fontWeight: 600 }}>Supported URLs only</span>
                  <br />
                  ...
                  <span style={{ color: '#6b7280' }}>
                    For Facebook posts, X/Twitter, or other platforms — download the image and use <strong style={{ color: '#94a3b8' }}>Upload File</strong> instead.
                  </span>
                </div>
              </div>
            )}
